"""
Django settings for start_date_48438 project.
...
ROOT_URLCONF = 'start_date_48438.urls'
...
WSGI_APPLICATION = 'start_date_48438.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Start Date Support <support@start-date-48438.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "start_date_48438 API",
    "DESCRIPTION": "API documentation for start_date_48438 App",
    "VERSION": "v1",
}
